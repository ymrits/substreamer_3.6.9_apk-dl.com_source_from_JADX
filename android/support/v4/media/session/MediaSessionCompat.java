...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00701 implements Creator<QueueItem> {
            C00701() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00711 implements Creator<ResultReceiverWrapper> {
            C00711() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00721 implements Creator<Token> {
            C00721() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0173R.styleable.AppCompatTheme_panelBackground /*79*/:
                        case C0173R.styleable.AppCompatTheme_colorAccent /*85*/:
                            boolean isPlaying;
                        ...
                        case C0173R.styleable.AppCompatTheme_colorControlNormal /*86*/:
                            if ((1 & validActions) != 0) {
                                cb.onStop();
                            }
                        case C0173R.styleable.AppCompatTheme_colorControlActivated /*87*/:
                            if ((32 & validActions) != 0) {
                                cb.onSkipToNext();
                            }
                        case C0173R.styleable.AppCompatTheme_colorControlHighlight /*88*/:
                            if ((16 & validActions) != 0) {
                                cb.onSkipToPrevious();
                            }
                        case C0173R.styleable.AppCompatTheme_colorButtonNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                            }
                        case C0173R.styleable.AppCompatTheme_colorSwitchThumbNormal /*90*/:
        ...
        class C02881 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02881() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
            ...
            this.mVolumeCallback = new C02881();
        ...
        int getRccStateFromState(int state) {
            switch (state) {
                case FileUtils.ACTION_GET_FILE /*0*/:
                    return 0;
                case MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS /*1*/:
                    return MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS;
                case MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS /*2*/:
                    return MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS;
                case FileUtils.WRITE /*3*/:
                    return 3;
                case MediaSessionCompat.FLAG_HANDLES_QUEUE_COMMANDS /*4*/:
                    return MediaSessionCompat.FLAG_HANDLES_QUEUE_COMMANDS;
        ...
        int getRccTransportControlFlagsFromActions(long actions) {
            ...
            if ((4 & actions) != 0) {
                transportControlFlags |= MediaSessionCompat.FLAG_HANDLES_QUEUE_COMMANDS;
            }
            if ((8 & actions) != 0) {
                transportControlFlags |= MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS;
            }
            if ((16 & actions) != 0) {
                transportControlFlags |= MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS;
            }
            if ((32 & actions) != 0) {
        ...
        MetadataEditor buildRccMetadata(Bundle metadata) {
            ...
            if (metadata != null) {
                ...
                if (metadata.containsKey(MediaMetadataCompat.METADATA_KEY_ALBUM)) {
                    editor.putString(MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS, metadata.getString(MediaMetadataCompat.METADATA_KEY_ALBUM));
                }
                ...
                if (metadata.containsKey(MediaMetadataCompat.METADATA_KEY_ARTIST)) {
                    editor.putString(MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS, metadata.getString(MediaMetadataCompat.METADATA_KEY_ARTIST));
                }
                ...
                if (metadata.containsKey(MediaMetadataCompat.METADATA_KEY_COMPOSER)) {
                    editor.putString(MediaSessionCompat.FLAG_HANDLES_QUEUE_COMMANDS, metadata.getString(MediaMetadataCompat.METADATA_KEY_COMPOSER));
                }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C00681 implements OnPlaybackPositionUpdateListener {
            C00681() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C00681());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C00691 implements OnMetadataUpdateListener {
            C00691() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C00691());
        }
        ...
        MetadataEditor buildRccMetadata(Bundle metadata) {
            ...
            if (metadata != null) {
                ...
                if (metadata.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                    editor.putObject(SQLiteNative.SQLC_RESULT_DONE, metadata.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
                }
