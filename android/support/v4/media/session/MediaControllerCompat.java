...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        private class StubApi26 extends StubApi21 implements android.support.v4.media.session.MediaControllerCompatApi26.Callback {
            private StubApi26() {
                super();
            }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        private class ExtraCallback extends Stub {
            ...
            class C00641 implements Runnable {
                ...
                C00641(String str, Bundle bundle) {
                    this.val$event = str;
            ...
            class C00652 implements Runnable {
                ...
                C00652(PlaybackStateCompat playbackStateCompat) {
            ...
            public void onEvent(String event, Bundle extras) throws RemoteException {
                this.mCallback.mHandler.post(new C00641(event, extras));
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat state) throws RemoteException {
                this.mCallback.mHandler.post(new C00652(state));
            }
            ...
            public void onRepeatModeChanged(int repeatMode) throws RemoteException {
                this.mCallback.mHandler.post(new C00663(repeatMode));
            }

            public void onShuffleModeChanged(boolean enabled) throws RemoteException {
                this.mCallback.mHandler.post(new C00674(enabled));
            }
    ...
    static class MediaControllerImplApi26 extends MediaControllerImplApi24 {
        ...
        MediaControllerImplApi26(Context context, Token sessionToken) throws RemoteException {
            super(context, sessionToken);
        }
    ...
    static class TransportControlsApi26 extends TransportControlsApi24 {
        ...
        public void setRepeatMode(int repeatMode) {
            android.support.v4.media.session.MediaControllerCompatApi26.TransportControls.setRepeatMode(this.mControlsObj, repeatMode);
        }

        public void setShuffleModeEnabled(boolean enabled) {
            android.support.v4.media.session.MediaControllerCompatApi26.TransportControls.setShuffleModeEnabled(this.mControlsObj, enabled);
        }
    }
