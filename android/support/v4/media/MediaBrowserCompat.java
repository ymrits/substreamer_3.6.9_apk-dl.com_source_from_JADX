...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        static class C00401 implements Creator<MediaItem> {
            C00401() {
            }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
        ...
        class C00282 implements Runnable {
            ...
            C00282(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        class C00304 implements Runnable {
            ...
            C00304(SearchCallback searchCallback, String str, Bundle bundle) {
        ...
        class C00315 implements Runnable {
            final /* synthetic */ SearchCallback val$callback;
            final /* synthetic */ Bundle val$extras;
            final /* synthetic */ String val$query;

            C00315(SearchCallback searchCallback, String str, Bundle bundle) {
                this.val$callback = searchCallback;
                this.val$query = str;
                this.val$extras = bundle;
            }
        ...
        class C00326 implements Runnable {
            ...
            C00326(SearchCallback searchCallback, String str, Bundle bundle) {
                this.val$callback = searchCallback;
                this.val$query = str;
                this.val$extras = bundle;
            }
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new C00282(cb, mediaId));
            } else {
                try {
        ...
        public void search(@NonNull String query, Bundle extras, @NonNull SearchCallback callback) {
            if (!isConnected()) {
                ...
                this.mHandler.post(new C00304(callback, query, extras));
            } else if (this.mServiceBinderWrapper == null) {
                Log.i(MediaBrowserCompat.TAG, "The connected service doesn't support search.");
                this.mHandler.post(new C00315(callback, query, extras));
            } else {
                try {
                    ...
                    this.mHandler.post(new C00326(callback, query, extras));
                }
            }
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        class C00364 implements Runnable {
            ...
            C00364(SearchCallback searchCallback, String str, Bundle bundle) {
                this.val$callback = searchCallback;
                this.val$query = str;
                this.val$extras = bundle;
            }
        ...
        class C00375 implements Runnable {
            final /* synthetic */ SearchCallback val$callback;
            final /* synthetic */ Bundle val$extras;
            final /* synthetic */ String val$query;

            C00375(SearchCallback searchCallback, String str, Bundle bundle) {
                this.val$callback = searchCallback;
                this.val$query = str;
                this.val$extras = bundle;
            }
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            class C00381 implements Runnable {
                ...
                C00381(ComponentName componentName, IBinder iBinder) {
            ...
            class C00392 implements Runnable {
                ...
                C00392(ComponentName componentName) {
                    this.val$name = componentName;
                }
            ...
            public void onServiceConnected(ComponentName name, IBinder binder) {
                postOrRun(new C00381(name, binder));
            }

            public void onServiceDisconnected(ComponentName name) {
                postOrRun(new C00392(name));
            }
        ...
        public void search(@NonNull String query, Bundle extras, @NonNull SearchCallback callback) {
            if (isConnected()) {
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error searching items with query: " + query, e);
                    this.mHandler.post(new C00375(callback, query, extras));
                    return;
                }
            }
            Log.i(MediaBrowserCompat.TAG, "Not connected, unable to search.");
            this.mHandler.post(new C00364(callback, query, extras));
        }
