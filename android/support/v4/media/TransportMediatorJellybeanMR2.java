...
class TransportMediatorJellybeanMR2 {
    ...
    class C00561 implements OnWindowAttachListener {
        C00561() {
        }
    ...
    class C00572 implements OnWindowFocusChangeListener {
        C00572() {
        }
    ...
    class C00594 implements OnAudioFocusChangeListener {
        C00594() {
        }
    ...
    class C00605 implements OnGetPlaybackPositionListener {
        C00605() {
        }
    ...
    class C00616 implements OnPlaybackPositionUpdateListener {
        C00616() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00561();
        this.mWindowFocusListener = new C00572();
        this.mMediaButtonReceiver = new C00583();
        this.mAudioFocusChangeListener = new C00594();
        this.mGetPlaybackPositionListener = new C00605();
        this.mPlaybackPositionUpdateListener = new C00616();
        this.mPlayState = 0;
