...
public class ViewPager extends ViewGroup {
    ...
    static class C00931 implements Comparator<ItemInfo> {
        C00931() {
        }
    ...
    static class C00942 implements Interpolator {
        C00942() {
        }
    ...
    class C00953 implements Runnable {
        C00953() {
        }
    ...
    class C02954 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02961 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02961() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02961());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00931();
        sInterpolator = new C00942();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00953();
    ...
    void initViewPager() {
        ...
        setDescendantFocusability(SQLiteNative.SQLC_OPEN_PRIVATECACHE);
        setFocusable(true);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02954());
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0173R.styleable.AppCompatTheme_spinnerStyle;
    ...
    private void enableLayers(boolean enable) {
        int childCount = getChildCount();
        for (int i = SCROLL_STATE_IDLE; i < childCount; i += SCROLL_STATE_DRAGGING) {
            getChildAt(i).setLayerType(enable ? this.mPageTransformerLayerType : SCROLL_STATE_IDLE, null);
        }
    }
    ...
    private boolean performDrag(float x) {
        ...
        if (scrollX < leftBound) {
            if (leftAbsolute) {
                f = (float) width;
                this.mLeftEdge.onPull(Math.abs(leftBound - scrollX) / r0);
            ...
            if (rightAbsolute) {
                f = (float) width;
                this.mRightEdge.onPull(Math.abs(scrollX - rightBound) / r0);
                needsInvalidate = true;
            }
            scrollX = rightBound;
        }
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int x, int y) {
        ...
        return (checkV && v.canScrollHorizontally(-dx)) ? true : DEBUG;
    }
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case SQLiteNative.SQLC_RESULT_MISUSE /*21*/:
                return arrowScroll(17);
            case C0173R.styleable.Toolbar_collapseIcon /*22*/:
                return arrowScroll(66);
            case C0173R.styleable.AppCompatTheme_popupMenuStyle /*61*/:
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
        ...
        if ((descendantFocusability == SQLiteNative.SQLC_OPEN_PRIVATECACHE && focusableCount != views.size()) || !isFocusable()) {
            return;
        }
