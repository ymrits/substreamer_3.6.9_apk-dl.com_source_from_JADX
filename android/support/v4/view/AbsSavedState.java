...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C02931 extends AbsSavedState {
        C02931() {
            super();
        }
    }
    ...
    static class C02942 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C02942() {
        }
    ...
    static {
        EMPTY_STATE = new C02931();
        CREATOR = ParcelableCompat.newCreator(new C02942());
    }
