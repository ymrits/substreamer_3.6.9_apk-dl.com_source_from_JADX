...
public class ViewCompat {
    ...
    static class ViewCompatApi21Impl extends ViewCompatApi19Impl {
        ...
        class C00911 implements OnApplyWindowInsetsListener {
            final /* synthetic */ OnApplyWindowInsetsListener val$listener;

            C00911(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
                this.val$listener = onApplyWindowInsetsListener;
            }

            public WindowInsets onApplyWindowInsets(View view, WindowInsets insets) {
                return (WindowInsets) WindowInsetsCompat.unwrap(this.val$listener.onApplyWindowInsets(view, WindowInsetsCompat.wrap(insets)));
            }
        }
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener listener) {
            if (listener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new C00911(listener));
            }
        }
