...
public final class MenuItemCompat {
    ...
    static class C00881 implements android.view.MenuItem.OnActionExpandListener {
        final /* synthetic */ OnActionExpandListener val$listener;

        C00881(OnActionExpandListener onActionExpandListener) {
    ...
    public static MenuItem setOnActionExpandListener(MenuItem item, OnActionExpandListener listener) {
        return item.setOnActionExpandListener(new C00881(listener));
    }
