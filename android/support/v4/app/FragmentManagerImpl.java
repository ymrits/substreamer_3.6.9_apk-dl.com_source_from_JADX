        ...
        public boolean generateOps(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) {
            if (FragmentManagerImpl.this.mPrimaryNav != null && this.mId < 0 && this.mName == null) {
                ...
                if (childManager != null && childManager.popBackStackImmediate()) {
                    return FragmentManagerImpl.HONEYCOMB;
                }
            }
...
*/
    ...
    static boolean shouldRunOnHWLayer(View v, Animation anim) {
        return (VERSION.SDK_INT >= 19 && v.getLayerType() == 0 && ViewCompat.hasOverlappingRendering(v) && modifiesAlpha(anim)) ? true : HONEYCOMB;
    }
    ...
    private void setHWLayerAnimListenerIfAlpha(View v, Animation anim) {
        if (v != null && anim != null && shouldRunOnHWLayer(v, anim)) {
            ...
            v.setLayerType(ANIM_STYLE_OPEN_EXIT, null);
    ...
    void ensureInflatedFragmentView(Fragment f) {
        if (f.mFromLayout && !f.mPerformedCreateView) {
            ...
            if (f.mView != null) {
                ...
                f.mView.setSaveFromParentEnabled(HONEYCOMB);
                if (f.mHidden) {
                    f.mView.setVisibility(8);
                }
                f.onViewCreated(f.mView, f.mSavedFragmentState);
                dispatchOnFragmentViewCreated(f, f.mView, f.mSavedFragmentState, HONEYCOMB);
                return;
            }
            f.mInnerView = null;
        }
    ...
    private boolean generateOpsForPendingActions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isPop) {
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < this.mPendingActions.size(); i += ANIM_STYLE_OPEN_ENTER) {
