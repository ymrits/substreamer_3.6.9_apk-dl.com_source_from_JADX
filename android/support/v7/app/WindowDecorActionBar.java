...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C03113 implements ViewPropertyAnimatorUpdateListener {
        C03113() {
        }
    ...
    class C03422 extends ViewPropertyAnimatorListenerAdapter {
        C03422() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C03411();
        this.mShowListener = new C03422();
        this.mUpdateListener = new C03113();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0136R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0136R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0136R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0136R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0136R.styleable.ActionBar, C0136R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0136R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0136R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0136R.attr.actionBarWidgetTheme, outValue, true);
