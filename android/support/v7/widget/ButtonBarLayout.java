...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0136R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0136R.styleable.ButtonBarLayout_allowStacking, allowStackingDefault);
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mAllowStacking && !isStacked()) {
            if ((getMeasuredWidthAndState() & ViewCompat.MEASURED_STATE_MASK) == AccessibilityEventCompat.TYPE_ASSIST_READING_CONTEXT) {
                setStacked(true);
                needsRemeasure = true;
            }
        }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0136R.id.spacer);
        if (spacer != null) {
