...
public class PopupMenu {
    ...
    class C01582 implements android.widget.PopupWindow.OnDismissListener {
        C01582() {
        }
    ...
    class C03181 implements Callback {
        C03181() {
        }
    ...
    class C03193 extends ForwardingListener {
        C03193(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0136R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03181());
        ...
        this.mPopup.setOnDismissListener(new C01582());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C03193(this.mAnchor);
        }
