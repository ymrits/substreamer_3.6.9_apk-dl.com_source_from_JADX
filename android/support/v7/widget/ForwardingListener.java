...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01541 implements OnAttachStateChangeListener {
        C01541() {
        }
    ...
    class C01552 implements OnGlobalLayoutListener {
        boolean mIsAttached;
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01541());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01552());
    }
